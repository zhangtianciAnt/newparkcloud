...
public class Detect {
    ...
    public static final String APP_ID = "15803618";
    public static final String API_KEY = "nb2MrGnjcixsONmnjTz4P325";
    public static final String SECRET_KEY = "rEKXaxVDvouhQqeqI6ejcsOrNlUOt8nj";
