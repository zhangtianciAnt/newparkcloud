...
import com.nt.dao_AOCHUAN.AOCHUAN2000.Vo.CustomerbaseinforVo;
...
public class AOCHUAN2001Controller {
    ...
    public ApiResult update(@RequestBody CustomerbaseinforVo customerbaseinforvo, HttpServletRequest request) throws Exception {
