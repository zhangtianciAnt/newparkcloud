 ...
 *       &lt;sequence&gt;
 *         &lt;element name="InterconnGetResultResult" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = {
    "interconnGetResultResult",
    "interConnStatus",
    "resultFilePath"
})
@XmlRootElement(name = "InterconnGetResultResponse")
public class InterconnGetResultResponse {

    @XmlElement(name = "InterconnGetResultResult")
    protected Boolean interconnGetResultResult;
     ...
     *
     */
    public Boolean isInterconnGetResultResult() {
        return interconnGetResultResult;
    }

    /**
     * ����interconnGetResultResult���Ե�ֵ��
     *
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *
     */
    public void setInterconnGetResultResult(Boolean value) {
        this.interconnGetResultResult = value;
    }
