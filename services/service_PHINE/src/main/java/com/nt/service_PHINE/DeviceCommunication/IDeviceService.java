...
public interface IDeviceService {
    ...
    public void getFpgaConfigStatus(
            ...
            @WebParam(name = "fpgaId", targetNamespace = "http://tempuri.org/")
                    Long fpgaId,
            @WebParam(mode = WebParam.Mode.INOUT, name = "configResult", targetNamespace = "http://tempuri.org/")
                    javax.xml.ws.Holder<ConfigStatus> configResult,
