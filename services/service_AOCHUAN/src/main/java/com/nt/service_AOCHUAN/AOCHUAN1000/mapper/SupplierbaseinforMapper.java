...
public interface SupplierbaseinforMapper extends MyMapper<Supplierbaseinfor> {
    ...
    @Select("select SUPPLIERBASEINFOR_ID,suppliernamecn,industryinvolved,address1,linkman,mobilephone,createon,kisid,supnumber from supplierbaseinfor  ORDER BY createon DESC")
