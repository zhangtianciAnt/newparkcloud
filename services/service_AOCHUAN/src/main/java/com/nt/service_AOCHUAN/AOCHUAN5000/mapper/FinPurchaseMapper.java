...
public interface FinPurchaseMapper extends MyMapper<FinPurchase> {
    ...
    //更新走货表
    void updateTransportGood(@Param("invoiceNo") String invoiceNo, @Param("ap_date") Date ap_date,@Param("paymentstatus") String paymentstatus,@Param("modifyby") String modifyby,@Param("id") String id);
}
