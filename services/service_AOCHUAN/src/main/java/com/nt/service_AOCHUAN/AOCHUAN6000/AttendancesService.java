...
public interface AttendancesService {
    ...
    List<Attendance> getNowMons(String attendancetim, List<String> ownerList) throws Exception;

    List<Attendance> getNowMonYC(String attendancetim, List<String> ownerList) throws Exception;
    ...
    //自动获取企业微信打卡
    List<Attendance> getAutoCheckInData(EWxBaseResponse data) throws Exception;
