                    ...
                    //if (ad.getUser_id().equals("5e0ee8a8c0911e1c24f1a57c")) {
                        ...
                        if (irregulartiminglist.size() == 0) {
                            ...
                            if (punchcardRecordlist.size() > 0) {
                                for (PunchcardRecord PR : punchcardRecordlist) {
                                    ...
                                    if (ovList.size() > 0) {
                                        for (Overtime Ot : ovList) {
                                            ...
                                            if (Ot.getOvertimetype().equals("PR001001")) {
                                                //平日加班
                                            ...
                                            else if(Ot.getOvertimetype().equals("PR001007") || Ot.getOvertimetype().equals("PR001008") || Ot.getOvertimetype().equals("PR001005"))
                                            {
                                                //五四青年节  妇女节   会社特别休日加班
                                                if(!actualoverTime.equals("0"))
                                                {
                                ...
                                if(!workinghours.equals("0") || !workinghours.equals("4"))
                                {
                                    ad.setNormal(null);
                                    ad.setAbsenteeism(null);
                                    ad.setShortsickleave(null);
