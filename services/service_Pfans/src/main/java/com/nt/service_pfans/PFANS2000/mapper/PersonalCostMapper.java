...
//
//    PersonalCostBmSum getPersonalCostSum(@Param("groupid") String groupid, @Param("yearsantid") String yearsantid);
//
//    PersonalCostBmSum getPersonalCostSumGp(@Param("groupid") String groupid, @Param("yearsantid") String yearsantid);

    List<PersonalCostBmSum> getDepShortList(@Param("yearsantid") String yearsantid);

    List<PersonalCostBmSum> getDepSum(@Param("DEPARTSHORT") String DEPARTSHORT);
