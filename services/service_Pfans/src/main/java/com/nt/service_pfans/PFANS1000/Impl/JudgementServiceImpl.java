    ...
    public void insert(JudgementVo judgementVo, TokenModel tokenModel) throws Exception {
        ...
        if(judgementVo.getJudgement().getSupplementary().equals("1")){
            ...
            if (judgementlist.size() > 0) {
                for (Judgement judgeAnt : judgementlist) {
                    if (judgeAnt.getJudgnumbers() != "" && judgeAnt.getJudgnumbers() != null) {
                       if(judgementnumberAnt.indexOf(judgeAnt.getJudgnumbers()) != -1){
                           intnumAnt ++;
                       }else{
            ...
            if(intnumAnt == 0){
                ...
                judgement.setJudgnumbers(judgementnumberAnt + "_" + (intnumAnt));
            }
//            String judgementnumberAnt = judgementVo.getJudgement().getJudgnumbers() + "_" + "tmp";
            ...
            //原决裁
            if(judgement.getOldjudgementid().equals("")){
                judgement.setOldjudgementid(judgementVo.getJudgement().getJudgementid());
            }else{
                String oldJudgementidAnt = "";
                oldJudgementidAnt = judgement.getOldjudgementid() + "," + judgementVo.getJudgement().getJudgementid();
                judgement.setOldjudgementid(oldJudgementidAnt);
            }
