...
public class IncomeExpenditureServiceImpl implements IncomeExpenditureService {
    ...
    @Override
    public List<ThemePlan> getdatalist() throws Exception {
        List<ThemePlan> themeplanlist = themePlanMapper.selectAll();
        List<ThemePlan> list = themeplanlist.stream().collect(
