...
public abstract class JxlsBuilder {
    ...
    public JxlsBuilder build() throws Exception {
        ...
        if (JxlsUtil.me().hasText(imageRoot)) {
            context.putVar("_iamgeRoot", imageRoot);
        }
        context.putVar("_ignoreImageMiss", ignoreImageMiss);

        JexlExpressionEvaluator evaluator = (JexlExpressionEvaluator) jxlsHelper.createExpressionEvaluator((String)null);
     ...
     * @return
     */
    public JxlsBuilder pubAll(Map<String, Object> map) {
