...
public class MsgConstants {
     ...
     * 参数对象无效
     */
    public final static String PARAM_ERR_02 = "PARAM_ERR_02";
     ...
     * 用户名或者密码错误
     */
    public final static String LOGIN_ERR_01 = "LOGIN_ERR_01";

    /**
     * 该用户不存在
     */
    public final static String USER_ERR_01 = "USER_ERR_01";
