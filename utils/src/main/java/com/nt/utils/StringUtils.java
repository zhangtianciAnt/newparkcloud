...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * 正则表达式：验证手机号
     */
    public static final String REGEX_MOBILE = "^((17[0-9])|(14[0-9])|(13[0-9])|(15[0-9])|(16[0-9])|(19[0-9])|(18[0-9]))\\d{8}$";
    ...
    public static boolean inString(String str, String... strs) {
        if (str != null) {
            for (String s : strs) {
                if (str.equals(trim(s))) { return true; }
            }
        }
        return false;
    }
     ...
     * @return 分隔后的字符串个数
     */
    public static int getSplitCount(String source, String separator) {
        if (source == null || separator == null) { return 0; }
